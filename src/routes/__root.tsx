  ...
  head: () => ({
    meta: [
      ...
      { title: "Secret Crush — Your Crush. Still a Secret. | Official Site" },
      {
        name: "description",
        content:
          "Secret Crush lets you add your crushes confidentially. We only reveal matches when interest is mutual. Owned and operated by ARCTURYN PRIVATE LIMITED.",
      },
      {
        name: "keywords",
        content:
          "Secret Crush, secret crush app, mutual crush finder, private matching app, ARCTURYN PRIVATE LIMITED, dating app india, secret crush ahmedabad",
      },
      ...
      { property: "og:title", content: "Secret Crush — Your Crush. Still a Secret." },
      {
        ...
        content:
          "Add your crushes secretly. We'll only tell you if it's mutual. Join the Secret Crush waitlist.",
      },
      ...
      { name: "twitter:title", content: "Secret Crush — Your Crush. Still a Secret." },
      {
        ...
        content: "Add your crushes secretly. We'll only tell you if it's mutual.",
      },
...
const organizationSchema = {
  ...
  sameAs: ["https://www.instagram.com/mysecretcrush.official/"],
};
...
const webAppSchema = {
  ...
  description:
    "Secret Crush allows you to secretly add your crushes. We only notify you if the crush connection is mutual (double-opt-in). Completely private and secure.",
  publisher: {
    "@type": "Organization",
    name: "ARCTURYN PRIVATE LIMITED",
  },
