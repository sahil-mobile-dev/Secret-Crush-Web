...
export const Route = createFileRoute("/app/terms-of-use")({
  head: () => ({
    meta: [
      { title: "Terms of Use — Secret Crush by ARCTURYN PRIVATE LIMITED" },
      {
        name: "description",
        content:
          "Terms of Use and Service Agreement for Secret Crush, owned and operated by ARCTURYN PRIVATE LIMITED.",
      },
      ...
      { property: "og:url", content: "https://mysecretcrush.in/app/terms-of-use" },
    ],
    links: [{ rel: "canonical", href: "https://mysecretcrush.in/terms-of-use" }],
  }),
            ...
            <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
              <section>
                <h2 className="text-lg font-semibold text-foreground mb-3">
                  1. Agreement to Terms & Service Provider
                </h2>
                <p>
                  By accessing or using Secret Crush, you agree to be bound by these Terms of Use
                  and all applicable laws and regulations. Secret Crush is owned and operated by{" "}
                  <strong className="text-foreground">ARCTURYN PRIVATE LIMITED</strong>, having its
                  registered office at 411, 4th Floor, SHREEYA AMALGA, Thaltej Road, Ahmedabad,
                  Gujarat, India 380054 ("Company", "we", "us", or "our"). If you do not agree with
                  any of these terms, you are prohibited from using or accessing this site or
                  service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">When register/creating an account, you agree to:</p>
              ...
              <section>
                ...
                <p className="mb-2">To ensure a safe and pleasant environment, you agree not to:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Impersonate any person or entity, including fake social media handles or
                    numbers.
                  </li>
                  <li>Use the service to stalk, harass, abuse, or spam other individuals.</li>
                  <li>
                    Attempt to bypass security measures or reverse engineer the matching logic.
                  </li>
              ...
              <section>
                ...
                <p>
                  We offer a limit of up to 3 crushes per account to keep choices meaningful and
                  reduce unwanted spam. We reserve the right to modify crush limits, suspend
                  accounts, or discontinue features at our discretion without prior notice.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Secret Crush is provided on an "as is" and "as available" basis. We make no
                  warranties, expressed or implied, regarding the accuracy, completeness, or
                  reliability of the service. We do not warrant that matches will be successful or
              ...
              <section>
                ...
                <p>
                  In no event shall ARCTURYN PRIVATE LIMITED, Secret Crush, or its directors and
                  officers be liable for any damages (including, without limitation, damages for
                  loss of data, emotional distress, or business interruption) arising out of the use
              ...
              <section>
                ...
                <p>
                  ...
                  of India. Any legal action, suit, or proceeding arising out of or relating to
